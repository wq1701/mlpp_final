...
class BPMF():
    def __init__(self, n_user, n_item, n_feature, beta=2.0, beta_user=2.0,
        ...
        self.n_user = n_user # number of users (69600)
        self.n_item = n_item # number of anime (9927)
        self.n_feature = n_feature # number of features for decomposition
...
if __name__ == "__main__":
    ...
    # ratings_my = pd.read_csv('/Users/weiwei_qi/wd/mlpp_final/ratings_real.csv').to_numpy()
    print("Loaded")
