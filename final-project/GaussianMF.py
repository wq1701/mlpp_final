...
def run_GaussianMF(anime_data_train, anime_data_test, anime_matrix_train): 
    import logging
    import os
    import warnings
    ...
    def matrix_factorization_normal(anime_matrix_train, k = 30):
    ...
    def guide_map(anime_matrix_train, k = 30):
